...
HOST = "moein.nrz"
ROWS = [
    ("Now",        "Artificial Intelligence · Deep Learning · Computer Vision"),
    ("Prev",       "Python · Django · AI Development · Deep Learning · Computer Vision · PyTorch · TensorFlow · C#"),
    ("Stack",      "Python · PyTorch · TensorFlow · OpenCV · Django · C# · Git"),
    ("Highlights", "Industrial Fall Detection · AI Hand Gesture Volume Control · AI / RAG Chatbot"),
    ("Learning",   "NLP · LLMs · Machine Learning · Deep Learning"),
    ("Reach",      "github.com/moeinnrz · linkedin.com/in/moein-norouzi-badelbu-nrz"),
]
# ------------------------------------------------------------------------------
